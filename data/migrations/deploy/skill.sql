...
CREATE TABLE "effect" (
    ...
    "level" INTEGER,
    "description" TEXT NOT NULL,
    "modifier_field" TEXT DEFAULT NULL,
    "modifier_operator" TEXT DEFAULT NULL,
    "modifier_value" INTEGER DEFAULT NULL
);
...
effect.modifier_field,
effect.modifier_operator,
effect.modifier_value
FROM effect
JOIN skill ON effect.skill_id = skill.id;
